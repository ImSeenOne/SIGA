<div class="modal fade" id="paymentDetails" tabindex="-1" role="dialog" aria-labelledby="paymentDetailsLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="width: 90%; margin-left: 5%">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="paymentDetailsLabel">Detalles del pago de raya</h3>
      ...
      <div class="modal-body">
        ...
        <div class="row" id="flAddedActivities" style="display: none;">
          <div class="container">
            <p>
            ...
            <p>
              <label>Obra:</label>
              <strong> <cite id="workCiteModal" style="color: #335cbd; display: inline;"></cite> </strong>
            </p>
            <p>
              <label>Período:</label>
          ...
          <br><br><br><br>
          <div class="table table-responsive container" id="cntnListPaymentActivitiesModal">
          </div>
        </div>
        <div id="paymentDataModal" style="display:none;" class="row">
          <div class="container-fluid">
            <ul class="list-group">
              ...
              <li class="list-group-item text-center">Obra: <div id="workModal" style="color: #335cbd; display: inline;"></div></li>
